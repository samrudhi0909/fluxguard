...
const (
	RateLimiter_ShouldAllow_FullMethodName = "/limiter.RateLimiter/ShouldAllow"
)
...
type RateLimiterClient interface {
	ShouldAllow(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *rateLimiterClient) ShouldAllow(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Response)
	err := c.cc.Invoke(ctx, RateLimiter_ShouldAllow_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RateLimiterServer interface {
	ShouldAllow(context.Context, *Request) (*Response, error)
...
func (UnimplementedRateLimiterServer) ShouldAllow(context.Context, *Request) (*Response, error) {
...
func _RateLimiter_ShouldAllow_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RateLimiterServer).ShouldAllow(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RateLimiter_ShouldAllow_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RateLimiterServer).ShouldAllow(ctx, req.(*Request))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _RateLimiter_ShouldAllow_Handler,
		},
	},
